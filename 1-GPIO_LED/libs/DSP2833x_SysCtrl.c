...
// known state.
// - Disables the watchdog  禁用看门狗
// - Set the PLLCR for proper SYSCLKOUT frequency 配置系统时钟
// - Set the pre-scaler for the high and low frequency peripheral clocks 配置外设时钟
// - Enable the clocks to the peripherals 使能外设时钟
//
void 
InitSysCtrl(void)
{
...
InitPeripheralClocks(void)
{
    ...
    SysCtrlRegs.PCLKCR0.bit.I2CAENCLK = 1;   // I2C           0是禁用时钟 1是开启时钟
